...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "9090529911",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "shubhamkumarvishwakarma77@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "Nagawara, Banglore",
  },
];
const Contact = () => {
  return (
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            ...
            >
              ...
              <p className="text-white/60">
                some descriptionn write on you own
              </p>
              {/* input  */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Input type="jobtitle" placeholder="Position" />
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="Freelance Work">
                      Freelance Work
                    </SelectItem>
